...
### 10.国际专线
`IPLC`和`IEPL`称之为内网专线，通常是不过墙的，因为它属于点对点的连接。但是内网专线并不指你的本机到指定外国服务器的点对点，你的数据依然要经过小区网络，运营商网络，然后才进入专线，所以专线的牛逼通常也受两段公网的影响。

所以即便是使用了国际专线也要去约束自己的行为。因为专线不受审查，但是两段公网是要审查的。

同时国际专线也并不代表碾压一切的快，毕竟专线只不过是其中一小段，而且也会受拥堵的影响，电信作为一级经销商会将线路卖给二级经销商，一层一层下去，所以实际上为什么要买大机场，就是因为越靠近上游就越可靠和便宜。
